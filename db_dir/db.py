...
async def insertPackage(name: str, version: str, dependencies: list, pkg_type:str, pkg_build_type: str):
    pool = await dbConnect()
    async with pool.acquire() as databasewriter:
        await databasewriter.execute("insert into packagesList (name, version, dependencies, pkg_type, build_type) values ($1, $2, $3, $4, $5)", name, version, dependencies, pkg_type, pkg_build_type)
